...
2. 克隆远程仓库到本地 `git clone `[`https://github.com/luggege/book.g`](https://github.com/luggege/book.git)`it`
...
1. cd .. 退出一层克隆远程仓库的gh-pages分支并保存为book_build文件夹:   `git clone -b gh-pages `_[`https://github.com/luggege/book.git`](https://github.com/luggege/book.git)_` book_build`_
